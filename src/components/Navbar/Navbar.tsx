    ...
    <nav className={styles.navbar}>
      <div className={styles.container}>
        <div className={styles.navContent}>
          {/* Логотип */}
          <div className={styles.logoText}>BLAGO YOGA ART</div>

          {/* Кнопки студий */}
          <div className={styles.studios}>
            {/* <button className={styles.studioBtn}>Digital Studio</button>
            <button className={styles.studioBtn}>NYC Studio</button> */}
            <button className={styles.studioBtn} onClick={() => setSidebarOpen(true)}>Связаться</button>
          </div>
      ...
      {isActive && (
        <div className={styles.sideMenu}>
          ...
          <div className={styles.menuSection}>
            ...
            <div className={styles.menuRow}><span>NYC Studio</span><button className={styles.bookBtn}>Book Now</button></div>
            <div className={styles.menuRow}><button className={styles.contactBtn} onClick={() => { setSidebarOpen(true); closeMenu(); }}>Связаться</button></div>
          </div>
          <hr className={styles.menuDivider} />
          <div className={styles.menuSection}>
          ...
          <div className={styles.menuHelp}><button>Помощь</button></div>
        </div>
      )}
